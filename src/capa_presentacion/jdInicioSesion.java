                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtContra, javax.swing.GroupLayout.DEFAULT_SIZE, 149, Short.MAX_VALUE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(25, 25, 25)
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if (objUsuario.validarVigencia(txtUsuario.getText())) {
            ...
            if (nombreUsuario.equals("")) {
                ...
                intentos++;
                if (intentos >= 3) {
                    JOptionPane.showMessageDialog(null, "Supero los 3 intentos. El sistema se cerrará");
                    System.exit(0);
                }
            } else {
